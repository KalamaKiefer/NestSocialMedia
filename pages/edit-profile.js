...
class EditProfile extends React.Component {
  ...
  handleChange = event => { // function to handle edits in edit profile
    let inputValue;
  ...
  render() {
    ...
    const { name, email, avatar, about, avatarPreview, isLoading, isSaving,
      updatedUser, openSuccess, openError, error } = this.state;
      ...
      <div className={classes.root}>
        <Paper className={classes.paper}>
          ...
          <form onSubmit={this.handleSubmit} className={classes.form}>
            ...
            <Button type="submit" fullWidth disabled={isSaving || isLoading}
              variant="contained" color="primary" className={classes.submit}
            >
              {isSaving ? "Saving Edits..." : "Save"}
            </Button>
          </form>
        </Paper>
          ...
          {/* error snackbar */}
          {error && <Snackbar
            anchorOrigin={{ // for displaying error message
              vertical: "top",
              horizontal: "center"
            }}
            open={openError}
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
              User {updatedUser && updatedUser.name} was succesfully updated!
            </DialogContentText>
          </DialogContent>
        </Dialog>
      </div>
...
EditProfile.getInitialProps = authInitialProps(true); // if unathorized kick them out
